...
*/
	...
	*/
	...
	{
		return preg_replace("/\\[(item|ress)_([a-zA-Z0-9]+)([-a-zA-Z0-9_]*)\\]/e", ($links?"'<a href=\"".h_root."/login/help/description.php?id=\$2&amp;".htmlspecialchars(urlencode(session_name()))."=".htmlspecialchars(urlencode(session_id()))."\">'.":"")."h(_('\$0'))".($links?".'</a>'" : ""), h($string));
	}
