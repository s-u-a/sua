...
<?php /*			var url_suffix = '<?=JS::jsentities(global_setting("URL_SUFFIX"))?>';*/ ?>
...
?>
		...
		<script type="text/javascript" src="<?=htmlspecialchars($this->getOption("h_root")."/login/res/javascript.js")?>"></script>
<?php
...
<?php
			...
			elseif(isset($skins[$my_skin[0]]))
				$skin_path = $this->getOption("h_root").'/login/res/style/'.urlencode($my_skin[0]).'/style.css';
...
<?php
			if($this->getOption("login_error"))
			{
?>
					<p class="error"><?=htmlspecialchars($this->getOption("login_error"))?></p>
<?php
			}
?>
...
?>
			...
			<ul id="main-navigation">
				<li<?=($_SERVER['PHP_SELF'] == $this->getOption("h_root").'/login/index.php') ? ' class="active"' : ''?> id="navigation-index"><a href="<?=htmlspecialchars('http://'.$_SERVER['HTTP_HOST'].$this->getOption("h_root"))?>/login/index.php?<?=htmlspecialchars(global_setting("URL_SUFFIX"))?>"<?=L::accesskeyAttr(_("&Übersicht[login/include.php|3]"))?>><?=L::h(_("&Übersicht[login/include.php|3]"))?></a></li>
				<li<?=($_SERVER['PHP_SELF'] == $this->getOption("h_root").'/login/rohstoffe.php') ? ' class="active"' : ''?> id="navigation-rohstoffe"><a href="<?=htmlspecialchars('http://'.$_SERVER['HTTP_HOST'].$this->getOption("h_root"))?>/login/rohstoffe.php?<?=htmlspecialchars(global_setting("URL_SUFFIX"))?>"<?=L::accesskeyAttr(_("&Rohstoffe[login/include.php|3]"))?>><?=L::h(_("&Rohstoffe[login/include.php|3]"))?></a></li>
				<li<?=($_SERVER['PHP_SELF'] == $this->getOption("h_root").'/login/gebaeude.php') ? ' class="active"' : ''?> id="navigation-gebaeude"><a href="<?=htmlspecialchars('http://'.$_SERVER['HTTP_HOST'].$this->getOption("h_root"))?>/login/gebaeude.php?<?=htmlspecialchars(global_setting("URL_SUFFIX"))?>"<?=L::accesskeyAttr(_("&Gebäude[login/include.php|3]"))?>><?=L::h(_("&Gebäude[login/include.php|3]"))?></a></li>
				<li<?=($_SERVER['PHP_SELF'] == $this->getOption("h_root").'/login/forschung.php') ? ' class="active"' : ''?> id="navigation-forschung"><a href="<?=htmlspecialchars('http://'.$_SERVER['HTTP_HOST'].$this->getOption("h_root"))?>/login/forschung.php?<?=htmlspecialchars(global_setting("URL_SUFFIX"))?>"<?=L::accesskeyAttr(_("&Forschung[login/include.php|3]"))?>><?=L::h(_("&Forschung[login/include.php|3]"))?></a></li>
				<li<?=($_SERVER['PHP_SELF'] == $this->getOption("h_root").'/login/roboter.php') ? ' class="active"' : ''?> id="navigation-roboter"><a href="<?=htmlspecialchars('http://'.$_SERVER['HTTP_HOST'].$this->getOption("h_root"))?>/login/roboter.php?<?=htmlspecialchars(global_setting("URL_SUFFIX"))?>"<?=L::accesskeyAttr(_("Ro&boter[login/include.php|3]"))?>><?=L::h(_("Ro&boter[login/include.php|3]"))?></a></li>
				<li<?=($_SERVER['PHP_SELF'] == $this->getOption("h_root").'/login/flotten.php') ? ' class="active"' : ''?> id="navigation-flotten"><a href="<?=htmlspecialchars('http://'.$_SERVER['HTTP_HOST'].$this->getOption("h_root"))?>/login/flotten.php?<?=htmlspecialchars(global_setting("URL_SUFFIX"))?>"<?=L::accesskeyAttr(_("F&lotten[login/include.php|3]"))?>><?=L::h(_("F&lotten[login/include.php|3]"))?></a></li>
				<li<?=($_SERVER['PHP_SELF'] == $this->getOption("h_root").'/login/schiffswerft.php') ? ' class="active"' : ''?> id="navigation-schiffswerft"><a href="<?=htmlspecialchars('http://'.$_SERVER['HTTP_HOST'].$this->getOption("h_root"))?>/login/schiffswerft.php?<?=htmlspecialchars(global_setting("URL_SUFFIX"))?>"<?=L::accesskeyAttr(_("&Schiffswerft[login/include.php|3]"))?>><?=L::h(_("&Schiffswerft[login/include.php|3]"))?></a></li>
				<li<?=($_SERVER['PHP_SELF'] == $this->getOption("h_root").'/login/verteidigung.php') ? ' class="active"' : ''?> id="navigation-verteidigung"><a href="<?=htmlspecialchars('http://'.$_SERVER['HTTP_HOST'].$this->getOption("h_root"))?>/login/verteidigung.php?<?=htmlspecialchars(global_setting("URL_SUFFIX"))?>"<?=L::accesskeyAttr(_("&Verteidigung[login/include.php|3]"))?>><?=L::h(_("&Verteidigung[login/include.php|3]"))?></a></li>
				<li<?=($_SERVER['PHP_SELF'] == $this->getOption("h_root").'/login/boerse.php') ? ' class="active"' : ''?> id="navigation-boerse"><a href="<?=htmlspecialchars('http://'.$_SERVER['HTTP_HOST'].$this->getOption("h_root"))?>/login/boerse.php?<?=htmlspecialchars(global_setting("URL_SUFFIX"))?>"<?=L::accesskeyAttr(_("Han&delsbörse[login/include.php|3]"))?>><?=L::h(_("Han&delsbörse[login/include.php|3]"))?></a></li>
				<li<?=($_SERVER['PHP_SELF'] == $this->getOption("h_root").'/login/imperium.php') ? ' class="active"' : ''?> id="navigation-imperium"><a href="<?=htmlspecialchars('http://'.$_SERVER['HTTP_HOST'].$this->getOption("h_root"))?>/login/imperium.php?<?=htmlspecialchars(global_setting("URL_SUFFIX"))?>"<?=L::accesskeyAttr(_("I&mperium[login/include.php|3]"))?>><?=L::h(_("I&mperium[login/include.php|3]"))?></a></li>
			</ul>
			<hr class="separator" id="navigation-separator-2" />
			<ul id="action-navigation">
				<li<?=($_SERVER['PHP_SELF'] == $this->getOption("h_root").'/login/karte.php') ? ' class="active"' : ''?> id="navigation-karte"><a href="<?=htmlspecialchars('http://'.$_SERVER['HTTP_HOST'].$this->getOption("h_root"))?>/login/karte.php?<?=htmlspecialchars(global_setting("URL_SUFFIX"))?>"<?=L::accesskeyAttr(_("&Karte[login/include.php|3]"))?>><?=L::h(_("&Karte[login/include.php|3]"))?></a></li>
				<li<?=($_SERVER['PHP_SELF'] == $this->getOption("h_root").'/login/allianz.php') ? ' class="active"' : ''?> id="navigation-allianz"><a href="<?=htmlspecialchars('http://'.$_SERVER['HTTP_HOST'].$this->getOption("h_root"))?>/login/allianz.php?<?=htmlspecialchars(global_setting("URL_SUFFIX"))?>"<?=L::accesskeyAttr(_("All&ianz[login/include.php|3]"))?>><?=L::h(_("All&ianz[login/include.php|3]"))?></a></li>
				<li<?=($_SERVER['PHP_SELF'] == $this->getOption("h_root").'/login/verbuendete.php') ? ' class="active"' : ''?> id="navigation-verbuendete"><a href="<?=htmlspecialchars('http://'.$_SERVER['HTTP_HOST'].$this->getOption("h_root"))?>/login/verbuendete.php?<?=htmlspecialchars(global_setting("URL_SUFFIX"))?>"<?=L::accesskeyAttr(_("V&erbündete[login/include.php|3]"))?>><?=L::h(_("V&erbündete[login/include.php|3]"))?></a></li>
				<li<?=($_SERVER['PHP_SELF'] == $this->getOption("h_root").'/login/highscores.php') ? ' class="active"' : ''?> id="navigation-highscores"><a href="<?=htmlspecialchars('http://'.$_SERVER['HTTP_HOST'].$this->getOption("h_root"))?>/login/highscores.php?<?=htmlspecialchars(global_setting("URL_SUFFIX"))?>"<?=L::accesskeyAttr(_("&Highscores[login/include.php|3]"))?>><?=L::h(_("&Highscores[login/include.php|3]"))?></a></li>
				<li<?=($_SERVER['PHP_SELF'] == $this->getOption("h_root").'/login/nachrichten.php') ? ' class="active"' : ''?> id="navigation-nachrichten"><a href="<?=htmlspecialchars('http://'.$_SERVER['HTTP_HOST'].$this->getOption("h_root"))?>/login/nachrichten.php?<?=htmlspecialchars(global_setting("URL_SUFFIX"))?>"<?=L::accesskeyAttr(_("Na&chrichten[login/include.php|3]"))?>><?=L::h(_("Na&chrichten[login/include.php|3]"))?></a></li>
				<li<?=($_SERVER['PHP_SELF'] == $this->getOption("h_root").'/login/forschungsbaum.php') ? ' class="active"' : ''?> id="navigation-abhaengigkeiten"><a href="<?=htmlspecialchars('http://'.$_SERVER['HTTP_HOST'].$this->getOption("h_root"))?>/login/forschungsbaum.php?<?=htmlspecialchars(global_setting("URL_SUFFIX"))?>"<?=L::accesskeyAttr(_("Forschungsb&aum[login/include.php|3]"))?>><?=L::h(_("Forschungsb&aum[login/include.php|3]"))?></a></li>
				<li<?=($_SERVER['PHP_SELF'] == $this->getOption("h_root").'/login/einstellungen.php') ? ' class="active"' : ''?> id="navigation-einstellungen"><a href="<?=htmlspecialchars('http://'.$_SERVER['HTTP_HOST'].$this->getOption("h_root"))?>/login/einstellungen.php?<?=htmlspecialchars(global_setting("URL_SUFFIX"))?>"<?=L::accesskeyAttr(_("Eins&tellungen[login/include.php|3]"))?>><?=L::h(_("Eins&tellungen[login/include.php|3]"))?></a></li>
<?php
...
<?php
				...
				{
?>
				<li id="navigation-abmelden"><a href="<?=htmlspecialchars('http://'.$_SERVER['HTTP_HOST'].$this->getOption("h_root"))?>/login/info/logout.php?<?=htmlspecialchars(global_setting("URL_SUFFIX"))?>"<?=L::accesskeyAttr(_("Abmelden&[login/include.php|3]"))?>><?=L::h(_("Abmelden&[login/include.php|3]"))?></a></li>
<?php
				}
?>
			</ul>
...
<?php
			...
			{
?>
			<li class="version"><a href="<?=htmlspecialchars('http://'.$_SERVER['HTTP_HOST'].$this->getOption("h_root"))?>/login/info/changelog.php?<?=htmlspecialchars(global_setting("URL_SUFFIX"))?>" title="<?=L::h(_("Changelog anzeigen&[login/include.php|4]"), false)?>"<?=L::accesskeyAttr(_("Changelog anzeigen&[login/include.php|4]"))?>><?=sprintf(h(_("Version %s")), htmlspecialchars(global_setting("VERSION")))?></a></li>
<?php
			}
?>
		</ul>
...
?>
<form action="<?=htmlspecialchars($this->getOption("protocol")."://".$_SERVER["HTTP_HOST"].$request_uri)?>" method="post" class="notloggedin">
	<fieldset>
		<dl class="form">
