...
function google_write_tracker(d, ad_url, tracker_event) {
  ...
  var img_src = 'https://pagead2.googlesyndication.com/pagead/imp.gif?event=';
...
function google_show_ad() {
  ...
  if (w.google_cpa_choice) {
    w.google_ad_url = 'https://pagead2.googlesyndication.com/cpa/ads?';
    ...
    w.google_ad_url = 'https://pagead2.googlesyndication.com/pagead/ads?';
    w.google_ad_url += 'client=' + 
                        escape(google_modify_client(w.google_ad_client));
  }
