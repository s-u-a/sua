...
<div class="faq" id="planets">
	...
	<p><?=h(sprintf(ngettext("Einige Spieler bevorzugen es, ein oder zwei Kolonien des %d-Planet-Limits offenzulassen, um später sogenannte „Raidkolonien“ besetzen zu können – solche Kolonien werden temporär besiedelt und auf %sproduktion spezialisiert, damit in einem Krieg der Feind schneller und billiger angeflogen werden kann.", "Einige Spieler bevorzugen es, ein oder zwei Kolonien des %d-Planeten-Limits offenzulassen, um später sogenannte „Raidkolonien“ besetzen zu können – solche Kolonien werden temporär besiedelt und auf %sproduktion spezialisiert, damit in einem Krieg der Feind schneller und billiger angeflogen werden kann.", global_setting("MAX_PLANETS")), global_setting("MAX_PLANETS"), _("Tritium")))?></p>
</div>
