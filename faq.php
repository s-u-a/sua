...
<div class="faq" id="requirements">
	<h3>Was brauche ich, um <abbr title="Stars Under Attack" xml:lang="en">S-U-A</abbr> zu spielen?</h3>
...
<div class="faq" id="noobs">
	<h3>Gibt es einen Anfängerschutz?</h3>
...
<div class="faq" id="times">
	<h3>Wie kann man die Bauzeiten verkürzen?</h3>
...
<div class="faq" id="research">
	<h3>Wo ist der Unterschied zwischen globaler und lokaler Forschung?</h3>
...
<div class="faq" id="fleet">
	<h3>Wieviele Flotten kann ich gleichzeitig verschicken?</h3>
...
<div class="faq" id="alliance">
	<h3>Was bringt mir ein Bündnis?</h3>
...
<div class="faq" id="resources">
	<h3>Die Rohstoffanzeige passt nicht in mein <span xml:lang="en">Browser</span>fenster und Quer<span xml:lang="en">scrollen</span> ist nicht möglich.</h3>
...
<div class="faq" id="name">
	<h3>Kann ich meinen Namen ändern?</h3>
...
<div class="faq" id="universe">
	<h3>Wie viele Universen gibt es?</h3>
...
<div class="faq" id="expand">
	<h3>Bei einem Gebäude/Forschung fehlt der Ausbauknopf oder bei meinen Robotern/Schiffen/Verteidigungsanlagen fehlt das Ausbaufeld.</h3>
...
<div class="faq" id="distance">
	<h3>Wie berechnet sich die Entfernung zwischen zwei Planeten?</h3>
