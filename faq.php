...
<div class="faq" id="planets">
	...
	<p><?=h(sprintf(ngettext("Ja, selbstverständlich. Derzeit können Sie maximal %s Planet haben.", "Ja, selbstverständlich. Derzeit können Sie maximal %s Planeten haben.", global_setting("MAX_PLANETS")), F::ths(global_setting("MAX_PLANETS"))))?></p>
