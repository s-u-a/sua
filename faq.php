...
<div class="faq" id="scores">
	...
	<p><?=h(_("Je mehr Tritium Sie im Flug verbrauchen, desto mehr Flugerfahrungspunkte erhalten Sie. Pro Tausend Tonnen Tritium, das Sie in einem erfolgreich am Ziel angelangten Flug verbraucht haben, bekommen Sie einen Flugerfahrungspunkt. Erfahrung im Flug lässt Ihre Schiffe schneller fliegen."))?></p>
...
<div class="faq" id="noobs">
	...
	<p><?=h(_("Ja, den gesamten Spielverlauf durch gilt eine Angriffssperre auf Spieler, die weniger als 5 % des eigenen Gesamtpunktestandes besitzen. Außerdem ist es Ihnen nicht möglich, Spieler anzugreifen, die aufgrund von Einschränkungen im Spiel (zum Beispiel dem Anfängerschutz) keine Angriffe auf Sie selbst fliegen können."))?></p>
</div>

<div class="faq" id="planets">
	<h3><?=h(_("Kann man mehrere Planeten haben?"))?></h3>
	<p><?=h(sprintf(ngettext("Ja, selbstverständlich. Derzeit können Sie maximal %d Planet haben.", "Ja, selbstverständlich. Derzeit können Sie maximal %d Planeten haben.", global_setting("MAX_PLANETS")), global_setting("MAX_PLANETS")))?></p>
	<p><?=h(_("Wenn Sie mit der Spionagesonde einen leeren Planeten ausspionieren, können Sie nachsehen, wieviele Felder dieser hat. Die Felderzahl variiert dabei unabhängig von der Position des Planeten, die Felderzahl beträgt 100–500 Felder. Haben Sie einen Planeten gefunden, den Sie besiedeln möchten, können Sie einem Besiedelungsschiff den Auftrag dazu erteilen."))?></p>
	...
	<p><?=h(sprintf(ngettext("Einige Spieler bevorzugen es, ein oder zwei Kolonien des %d-Planet-Limits offenzulassen, um später sogenannte „Raidkolonien“ besetzen zu können – solche Kolonien werden temporär besiedelt und auf Tritiumproduktion spezialisiert, damit in einem Krieg der Feind schneller und billiger angeflogen werden kann.", "Einige Spieler bevorzugen es, ein oder zwei Kolonien des %d-Planeten-Limits offenzulassen, um später sogenannte „Raidkolonien“ besetzen zu können – solche Kolonien werden temporär besiedelt und auf Tritiumproduktion spezialisiert, damit in einem Krieg der Feind schneller und billiger angeflogen werden kann.", global_setting("MAX_PLANETS")), global_setting("MAX_PLANETS")))?></p>
</div>
...
<div class="faq" id="expand">
	...
	<ul>
		<li><?=h(_("Der Planet ist ausgebaut. Ein Weiterbau der meisten Gebäude ist somit nicht möglich. Entwickeln Sie die Ingeneurswissenschaft oder bauen Sie Gebäude zurück, um wieder freie Felder zu erlangen."))?></li>
