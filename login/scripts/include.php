...
?>
			...
			<ul id="main-navigation">
				...
				<li<?=($_SERVER['PHP_SELF'] == h_root.'/login/boerse.php') ? ' class="active"' : ''?> id="navigation-boerse"><a href="<?=htmlentities('http://'.$_SERVER['HTTP_HOST'].h_root)?>/login/boerse.php?<?=htmlentities(urlencode(session_name()).'='.urlencode(session_id()))?>" accesskey="d">Han<kbd>d</kbd>elsbörse</a></li>
