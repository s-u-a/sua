...
*/
	...
	if(!$me->allianceTag() || !($alliance = Classes::Alliance($me->allianceTag())) || !$alliance->getStatus())
	{
		...
		if($application)
		{
			...
			{
?>
<h2><a href="allianz.php?<?=htmlspecialchars(urlencode(session_name()).'='.urlencode(session_id()))?>" title="<?=h(_("Zurück zur Allianzübersicht"))?>" tabindex="<?=$tabindex++?>"<?=accesskey_attr(_("Allian&z[login/allianz.php|0]"))?>><?=h(_("Allian&z[login/allianz.php|0]"))?></a></h2>
...
?>
<h2><?=h(_("Allianz"))?></h2>
<p class="allianz-laufende-bewerbung successful"><?=sprintf(h(_("Sie haben derzeit eine laufende Bewerbung bei der Allianz %s.")), "<a href=\"help/allianceinfo.php?alliance=".htmlspecialchars(urlencode($application)."&".urlencode(session_name()).'='.urlencode(session_id()))."\">".htmlspecialchars($application)."</a>")?></p>
<ul class="allianz-laufende-bewerbung-aktionen possibilities">
	<li><a href="allianz.php?action=cancel&amp;<?=htmlspecialchars(urlencode(session_name()).'='.urlencode(session_id()))?>"<?=accesskey_attr(_("Bewerbung zurückziehen&[login/allianz.php|1]"))?>><?=h(_("Bewerbung zurückziehen&[login/allianz.php|1]"))?></a></li>
</ul>
<?php
			}
		}
		...
		{
?>
<h2><a href="allianz.php?<?=htmlspecialchars(urlencode(session_name()).'='.urlencode(session_id()))?>" title="<?=h(_("Zurück zur Allianzübersicht"))?>" tabindex="<?=$tabindex++?>"<?=accesskey_attr(_("Allian&z[login/allianz.php|2]"))?>><?=h(_("Allian&z[login/allianz.php|2]"))?></a></h2>
<?php
...
?>
<form action="allianz.php?action=gruenden&amp;<?=htmlspecialchars(urlencode(session_name()).'='.urlencode(session_id()))?>" method="post" class="allianz-gruenden-form">
	<dl class="form">
	...
	<div class="button"><button type="submit" tabindex="<?=$tabindex++?>"<?=accesskey_attr(_("Allian&z gründen[login/allianz.php|2]"))?>><?=h(_("Allian&z gründen[login/allianz.php|2]"))?></button></div>
</form>
<?php
		}
		elseif($action == 'apply')
		{
			...
			{
?>
<h2><a href="allianz.php?<?=htmlspecialchars(urlencode(session_name()).'='.urlencode(session_id()))?>" title="<?=h(_("Zurück zur Allianzübersicht"))?>" tabindex="<?=$tabindex++?>"<?=accesskey_attr(_("Allian&z[login/allianz.php|3]"))?>><?=h(_("Allian&z[login/allianz.php|3]"))?></a></h2>
...
<?php
			...
			else
			{
				...
				{
?>
<h2><a href="allianz.php?<?=htmlspecialchars(urlencode(session_name()).'='.urlencode(session_id()))?>" title="<?=h(_("Zurück zur Allianzübersicht"))?>" tabindex="<?=$tabindex++?>"<?=accesskey_attr(_("Allian&z[login/allianz.php|4]"))?>><?=h(_("Allian&z[login/allianz.php|4]"))?></a></h2>
...
<?php
				...
				{
?>
<h2><a href="allianz.php?<?=htmlspecialchars(urlencode(session_name()).'='.urlencode(session_id()))?>" title="<?=h(_("Zurück zur Allianzübersicht"))?>" tabindex="<?=$tabindex++?>"<?=accesskey_attr(_("Allian&z[login/allianz.php|5]"))?>><?=h(_("Allian&z[login/allianz.php|5]"))?></a></h2>
<form action="allianz.php?action=apply&amp;for=<?=htmlspecialchars(urlencode($_GET['for']))?>&amp;<?=htmlspecialchars(urlencode(session_name()).'='.urlencode(session_id()))?>" method="post" class="allianz-bewerben-form">
	<dl class="form">
	...
	<div class="button"><button type="submit" tabindex="<?=$tabindex++?>"<?=accesskey_attr(_("Bewerbu&ng absenden[login/allianz.php|5]"))?>><?=h(_("Bewerbu&ng absenden[login/allianz.php|5]"))?></button></div>
</form>
<?php
				}
				else
				{
?>
<h2><a href="allianz.php?<?=htmlspecialchars(urlencode(session_name()).'='.urlencode(session_id()))?>" title="<?=h(_("Zurück zur Allianzübersicht"))?>" tabindex="<?=$tabindex++?>"<?=accesskey_attr(_("Allian&z[login/allianz.php|6]"))?>><?=h(_("Allian&z[login/allianz.php|6]"))?></a></h2>
<?php
...
<form action="allianz.php" method="get" class="allianz-moeglichkeiten">
	<ul class="possibilities">
		<li><a href="allianz.php?action=gruenden&amp;<?=htmlspecialchars(urlencode(session_name()).'='.urlencode(session_id()))?>" tabindex="<?=$tabindex+2?>"<?=accesskey_attr(_("Eigene Allian&z gründen[login/allianz.php|7]"))?>><?=h(_("Eigene Allian&z gründen[login/allianz.php|7]"))?></a></li>
		<li><input type="text" name="search" value="<?=(isset($_GET['search'])) ? htmlspecialchars($_GET['search']) : ''?>" tabindex="<?=$tabindex++?>"<?=accesskey_attr(_("Allia&nz suchen[login/allianz.php|7]"))?> /> <button type="submit" tabindex="<?=$tabindex++?>"><?=h(_("Allia&nz suchen[login/allianz.php|7]"))?></button><input type="hidden" name="<?=htmlspecialchars(session_name())?>" value="<?=htmlspecialchars(session_id())?>" /></li>
	</ul>
</form>
<?php
			$tabindex += 2;
...
<?php
					...
					{
?>
	<li><a href="help/allianceinfo.php?alliance=<?=htmlspecialchars(urlencode($alliance))?>&amp;<?=htmlspecialchars(urlencode(session_name()).'='.urlencode(session_id()))?>" title="<?=h(_("Genauere Informationen anzeigen"))?>"><?=htmlspecialchars($alliance)?></a></li>
<?php
					}
?>
</ul>
	...
	else
	{
		if($action == 'liste')
		{
			...
			if(!isset($_GET['invert']) || !$_GET['invert'])
				...
				$invert = '';
?>
<h2><a href="allianz.php?<?=htmlspecialchars(urlencode(session_name()).'='.urlencode(session_id()))?>" title="<?=h(_("Zurück zur Allianzübersicht"))?>" tabindex="<?=$tabindex++?>"<?=accesskey_attr(_("Allian&z[login/allianz.php|8]"))?>><?=h(_("Allian&z[login/allianz.php|8]"))?></a></h2>
<?php
			...
			{
?>
<form action="allianz.php?action=liste<?=isset($_GET['sortby']) ? '&amp;sortby='.htmlspecialchars(urlencode($_GET['sortby'])) : ''?><?=isset($_GET['invert']) ? '&amp;invert='.htmlspecialchars(urlencode($_GET['invert'])) : ''?>&amp;<?=htmlspecialchars(urlencode(session_name()).'='.urlencode(session_id()))?>" method="post" class="allianz-liste-form">
<?php
			}
...
<table class="allianz-liste">
	<thead>
		<tr>
			<th class="c-name"><a href="allianz.php?action=liste<?=$sort ? '' : $invert?>&amp;<?=htmlspecialchars(urlencode(session_name()).'='.urlencode(session_id()))?>" title="<?=h(_("Nach Namen sortieren"))?>"<?=accesskey_attr(_("Name&[login/allianz.php|8]"))?>><?=h(_("Name&[login/allianz.php|8]"))?></a></th>
			<th class="c-rang"><a href="allianz.php?action=liste&amp;sortby=rang<?=($sort && $_GET['sortby'] == 'rang') ? $invert : ''?>&amp;<?=htmlspecialchars(urlencode(session_name()).'='.urlencode(session_id()))?>" title="<?=h(_("Nach Rang sortieren"))?>"<?=accesskey_attr(_("Rang&[login/allianz.php|8]"))?>><?=h(_("Rang&[login/allianz.php|8]"))?></a></th>
			<th class="c-punkte"><a href="allianz.php?action=liste&amp;sortby=punkte<?=($sort && $_GET['sortby'] == 'punkte') ? $invert : ''?>&amp;<?=htmlspecialchars(urlencode(session_name()).'='.urlencode(session_id()))?>" title="<?=h(_("Nach Punkten sortieren"))?>"<?=accesskey_attr(_("P&unkte[login/allianz.php|8]"))?>><?=h(_("P&unkte[login/allianz.php|8]"))?></a></th>
			<th class="c-aufnahmezeit"><a href="allianz.php?action=liste&amp;sortby=time<?=($sort && $_GET['sortby'] == 'time') ? $invert : ''?>&amp;<?=htmlspecialchars(urlencode(session_name()).'='.urlencode(session_id()))?>" title="<?=h(_("Nach Aufnahmezeit sortieren"))?>"<?=accesskey_attr(_("Auf&nahmezeit[login/allianz.php|8]"))?>><?=h(_("Auf&nahmezeit[login/allianz.php|8]"))?></a></th>
<?php
			if($alliance->checkUserPermissions($_SESSION['username'], 5))
			{
?>
...
?>
		<tr>
			<th class="c-name"><a href="help/playerinfo.php?player=<?=htmlspecialchars(urlencode($member_name))?>&amp;<?=htmlspecialchars(urlencode(session_name()).'='.urlencode(session_id()))?>" title="<?=h(_("Informationen zu diesem Spieler anzeigen"))?>"><?=htmlspecialchars($member_name)?></a></th>
<?php
...
<?php
			...
			{
?>
	<div class="button"><button type="submit" tabindex="<?=$tabindex++?>"<?=accesskey_attr(_("Ä&nderungen speichern[login/allianz.php|8]"))?>><?=h(_("Ä&nderungen speichern[login/allianz.php|8]"))?></button></div>
</form>
<?php
			}
			if($alliance->checkUserPermissions($_SESSION['username'], 5))
		...
		else
		{
			...
			{
?>
<h2><a href="allianz.php?<?=htmlspecialchars(urlencode(session_name()).'='.urlencode(session_id()))?>" title="<?=h(_("Zurück zur Allianzübersicht"))?>" tabindex="<?=$tabindex++?>"<?=accesskey_attr(_("Allian&z[login/allianz.php|9]"))?>><?=h(_("Allian&z[login/allianz.php|9]"))?></a></h2>
<?php
...
<?php
			...
			{
?>
<h2><a href="allianz.php?<?=htmlspecialchars(urlencode(session_name()).'='.urlencode(session_id()))?>" title="<?=h(_("Zurück zur Allianzübersicht"))?>" tabindex="<?=$tabindex++?>"<?=accesskey_attr(_("Allian&z[login/allianz.php|10]"))?>><?=h(_("Allian&z[login/allianz.php|10]"))?></a></h2>
<?php
				if($me->quitAlliance())
				{
?>
...
?>
<h2><a href="allianz.php?<?=htmlspecialchars(urlencode(session_name()).'='.urlencode(session_id()))?>" title="<?=h(_("Zurück zur Allianzübersicht"))?>" tabindex="<?=$tabindex++?>"<?=accesskey_attr(_("Allian&z[login/allianz.php|11]"))?>><?=h(_("Allian&z[login/allianz.php|11]"))?></a></h2>
<form action="allianz.php?action=intern&amp;<?=htmlspecialchars(urlencode(session_name()).'='.urlencode(session_id()))?>" method="post" class="allianz-intern-form">
	<dl class="form">
	...
	<div class="button"><button type="submit" tabindex="<?=$tabindex++?>"<?=accesskey_attr(_("Speicher&n[login/allianz.php|11]"))?>><?=h(_("Speicher&n[login/allianz.php|11]"))?></button></div>
</form>
<?php
				$tabindex++;
			}
			...
			{
?>
<h2><a href="allianz.php?<?=htmlspecialchars(urlencode(session_name()).'='.urlencode(session_id()))?>" title="<?=h(_("Zurück zur Allianzübersicht"))?>" tabindex="<?=$tabindex++?>"<?=accesskey_attr(_("Allian&z[login/allianz.php|12]"))?>><?=h(_("Allian&z[login/allianz.php|12]"))?></a></h2>
<?php
...
?>
<form action="allianz.php?action=extern&amp;<?=htmlspecialchars(urlencode(session_name()).'='.urlencode(session_id()))?>" method="post" class="allianz-extern-form">
	<dl class="form">
	...
	<div class="button"><button type="submit" tabindex="<?=$tabindex++?>"<?=accesskey_attr(_("Speicher&n[login/allianz.php|12]"))?>><?=h(_("Speicher&n[login/allianz.php|12]"))?></button></div>
</form>
<?php
				$tabindex += 3;
			}
			...
			{
?>
<h2><a href="allianz.php?<?=htmlspecialchars(urlencode(session_name()).'='.urlencode(session_id()))?>" title="<?=h(_("Zurück zur Allianzübersicht"))?>" tabindex="<?=$tabindex++?>"<?=accesskey_attr(_("Allian&z[login/allianz.php|13]"))?>><?=h(_("Allian&z[login/allianz.php|13]"))?></a></h2>
<form action="allianz.php?action=permissions&amp;<?=htmlspecialchars(urlencode(session_name()).'='.urlencode(session_id()))?>" method="post" class="allianz-rechte-form">
	<table>
		<thead>
			<tr>
				<th><?=h(_("Mitglied"))?></th>
...
?>
			<tr>
				<th><a href="help/playerinfo.php?player=<?=htmlspecialchars(urlencode($member_name))?>&amp;<?=htmlspecialchars(urlencode(session_name()).'='.urlencode(session_id()))?>" title="<?=h(_("Informationen zu diesem Spieler anzeigen"))?>"><?=htmlspecialchars($member_name)?></a><input type="hidden" name="permissions[<?=htmlspecialchars($i)?>][9]" value="on" /></th>
...
?>
	...
	<div class="button"><button type="submit"<?=accesskey_attr(_("Speichern&[login/allianz.php|13]"))?>><?=h(_("Speichern&[login/allianz.php|13]"))?></button></div>
</form>
<?php
			}
			else
...
<?php
						...
						{
?>
	<dt><a href="help/playerinfo.php?player=<?=htmlspecialchars(urlencode($bewerbung))?>&amp;<?=htmlspecialchars(urlencode(session_name()).'='.urlencode(session_id()))?>"><?=htmlspecialchars($bewerbung)?></a></dt>
	<dd><ul>
		<li><a href="allianz.php?action=annehmen&amp;which=<?=htmlspecialchars(urlencode($bewerbung))?>&amp;<?=htmlspecialchars(urlencode(session_name()).'='.urlencode(session_id()))?>"><?=h(_("Annehmen"))?></a></li>
		<li><a href="allianz.php?action=ablehnen&amp;which=<?=htmlspecialchars(urlencode($bewerbung))?>&amp;<?=htmlspecialchars(urlencode(session_name()).'='.urlencode(session_id()))?>" onclick="return confirm('<?=jsentities(sprintf(_("Sind Sie sicher, dass Sie die Bewerbung des Benutzers %s ablehnen wollen?"), $bewerbung))?>');"><?=h(_("Ablehnen"))?></a></li>
	</ul></dd>
<?php
						}
?>
...
<dl class="allianceinfo">
	...
	<dd class="c-mitglieder"><?=htmlspecialchars($alliance->getMembersCount())?> <span class="liste">(<a href="allianz.php?action=liste&amp;<?=htmlspecialchars(urlencode(session_name()).'='.urlencode(session_id()))?>" title="Mitgliederliste der Allianz einsehen [Z]" tabindex="<?=$tabindex++?>" accesskey="z">Liste</a>)</span></dd>
...
<?php
					...
					{
?>
	<li class="c-austreten"><a href="allianz.php?action=austreten&amp;<?=htmlspecialchars(urlencode(session_name()).'='.urlencode(session_id()))?>" onclick="return confirm('<?=jsentities(_("Wollen Sie wirklich aus der Allianz austreten?"))?>');"<?=accesskey_attr(_("Aus der Allianz austreten&[login/allianz.php|13]"))?>><?=h(_("Aus der Allianz austreten&[login/allianz.php|13]"))?></a></li>
<?php
					}
					if($alliance->checkUserPermissions($_SESSION['username'], 8))
					{
?>
	<li class="c-aufloesen"><a href="allianz.php?action=aufloesen&amp;<?=htmlspecialchars(urlencode(session_name()).'='.urlencode(session_id()))?>" onclick="if(confirm('<?=jsentities(_("Sind Sie sicher, dass Sie diese Allianz komplett auflösen und allen Mitgliedern die Mitgliedschaft kündigen wollen?"))?>')) return !confirm('<?=jsentities(_("Haben Sie es sich doch noch anders überlegt?"))?>'); else return false;"<?=accesskey_attr(_("Allianz auflösen&[login/allianz.php|13]"))?>><?=h(_("Allianz auflösen&[login/allianz.php|13]"))?></a></li>
<?php
					}
					if($alliance->checkUserPermissions($_SESSION['username'], 2))
					{
?>
	<li class="c-interner-bereich"><a href="allianz.php?action=intern&amp;<?=htmlspecialchars(urlencode(session_name()).'='.urlencode(session_id()))?>" tabindex="<?=$tabindex++?>"<?=accesskey_attr(_("I&nternen Bereich bearbeiten[login/allianz.php|13]"))?>><?=h(_("I&nternen Bereich bearbeiten[login/allianz.php|13]"))?></a></li>
<?php
					}
					if($alliance->checkUserPermissions($_SESSION['username'], 3))
					{
?>
	<li class="c-externer-bereich"><a href="allianz.php?action=extern&amp;<?=htmlspecialchars(urlencode(session_name()).'='.urlencode(session_id()))?>" tabindex="<?=$tabindex++?>"<?=accesskey_attr(_("E&xternen Bereich bearbeiten[login/alliance.php|13]"))?>><?=h(_("E&xternen Bereich bearbeiten[login/alliance.php|13]"))?></a></li>
<?php
					}
					if($alliance->checkUserPermissions($_SESSION['username'], 7))
					{
?>
	<li class="c-benutzerrechte"><a href="allianz.php?action=permissions&amp;<?=htmlspecialchars(urlencode(session_name()).'='.urlencode(session_id()))?>" tabindex="<?=$tabindex++?>"<?=accesskey_attr(_("Benutzerrechte ver&walten[login/alliance.php|3]"))?>><?=h(_("Benutzerrechte ver&walten[login/alliance.php|3]"))?></a></li>
<?php
					}
?>
</ul>
...
?>
<form action="allianz.php?<?=htmlspecialchars(urlencode(session_name()).'='.urlencode(session_id()))?>#allianzrundschreiben" method="post" class="allianz-rundschreiben-form">
	<dl class="form">
	...
	<div class="button"><button type="submit"<?=accesskey_attr(_("Allianzrundschreiben verschicken&[login/allianz.php|13]"))?>><?=h(_("Allianzrundschreiben verschicken&[login/allianz.php|13]"))?></button></div>
</form>
<?php
				}
			}
