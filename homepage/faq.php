...
<ol id="question-list">
	...
	<li><a href="#certification"><?=l::h(_("Warum bekomme ich immer eine Meldung „Ungültiges Zertifikat“?"))?></a></li>
	<li><a href="#scores"><?=l::h(_("Wie bekomme ich Punkte?"))?></a></li>
	<li><a href="#noobs"><?=l::h(_("Gibt es einen Anfängerschutz?"))?></a></li>
	<li><a href="#planets"><?=l::h(_("Kann man mehrere Planeten haben?"))?></a></li>
	<li><a href="#umode"><?=l::h(_("Was bewirkt der Urlaubsmodus?"))?></a></li>
	<li><a href="#times"><?=l::h(_("Wie kann man die Bauzeiten verkürzen?"))?></a></li>
	<li><a href="#avatars"><?=l::h(_("Wie füge ich ein Bild in meine Allianz- oder Benutzerbeschreibung ein?"))?></a></li>
	<li><a href="#time"><?=l::h(_("Was bedeuten Server- und Lokalzeit?"))?></a></li>
	<li><a href="#research"><?=l::h(_("Wo ist der Unterschied zwischen lokaler und globaler Forschung?"))?></a></li>
	<li><a href="#robots"><?=l::h(_("Wie funktionieren die Roboter?"))?></a></li>
	<li><a href="#fleet"><?=l::h(_("Wieviele Flotten kann ich gleichzeitig verschicken?"))?></a></li>
	<li><a href="#alliance"><?=l::h(_("Was bringt mir ein Bündnis?"))?></a></li>
	<li><a href="#resources"><?=l::h(_("Die Rohstoffanzeige passt nicht in mein Browserfenster und Querscrollen ist nicht möglich."))?></a></li>
	<li><a href="#administrators"><?=l::h(_("Wie kann ich die Administratoren erreichen?"))?></a></li>
	<li><a href="#name"><?=l::h(_("Kann ich meinen Namen ändern?"))?></a></li>
	<li><a href="#universe"><?=l::h(_("Wie viele Universen gibt es?"))?></a></li>
	<li><a href="#expand"><?=l::h(_("Bei einem Gebäude/Forschung fehlt der Ausbauknopf oder bei meinen Robotern/Schiffen/Verteidigungsanlagen fehlt das Ausbaufeld."))?></a></li>
	<li><a href="#distance"><?=l::h(_("Wie berechnet sich die Entfernung zwischen zwei Planeten?"))?></a></li>
	<li><a href="#download"><?=l::h(_("Wie kann ich mir das Spiel herunterladen?"))?></a></li>
</ol>

<div class="faq" id="requirements">
	<h3><?=l::h(sprintf(_("Was brauche ich, um %s zu spielen?"), _("title_abbr")))?></h3>
	<p><?=l::h(_("Um das Spiel zu spielen, benötigen Sie lediglich einen Internetbrowser, der HTML 4 unterstützt. Sie können also quasi jeden Browser verwenden, vom normalen Firefox über den Terminalbrowser bis hin zum Vorleseprogramm für Blinde."))?></p>
	<p><?=l::h(_("Um das Design in seinen vollen Zügen zu genießen, benötigen Sie einen Browser aus der folgenden Liste."))?></p>
	<ul>
		<li><?=l::h(_("Mozilla Firefox (oder gleichwertige Gecko-Browser, wie Netscape Navigator oder Mozilla Suite)"))?></li>
		<li><?=l::h(_("Konqueror (in einer neueren Version, bestenfalls 3.2 oder neuer)"))?></li>
		<li><?=l::h(_("Safari (siehe Konqueror)"))?></li>
		<li><?=l::h(_("Opera (ab Version 7)"))?></li>
		<li><?=l::h(_("Internet Explorer (Version 5.5 oder 6)"))?></li>
	</ul>
	<p><?=l::h(_("Für einige praktische Features können Sie außerdem JavaScript aktivieren."))?></p>
	<p><?=l::h(_("Wir möchten Sie wärmstens darum bitten, nicht den Internet Explorer zu verwenden, sofern Sie die Möglichkeit dazu haben, da dieser sich in zu geringem Maße an Internet-Standards hält und dadurch für ein unnötig hohes zusätzliches Arbeitsaufkommen bei uns sorgt."))?></p>
</div>
...
<div class="faq" id="scores">
	<h3><?=l::h(_("Wie bekomme ich Punkte?"))?></h3>
	<p><?=l::h(_("Gebäude-, Forschungs-, Roboter-, Flotten- und Verteidigungspunkte berechnen sich aus den Rohstoffen, die die Gebäude/Forschungen/Robotern/Flotten/Verteidigungsanlagen an Rohstoffen gekostet haben, die Sie besitzen. Pro Tausend Rohstoffe bekommen Sie dabei einen Punkt in der entsprechenden Kategorie."))?></p>
	<p><?=l::h(sprintf(_("Je mehr %s Sie im Flug verbrauchen, desto mehr Flugerfahrungspunkte erhalten Sie. Pro Tausend Tonnen %1\$s, das Sie in einem erfolgreich am Ziel angelangten Flug verbraucht haben, bekommen Sie einen Flugerfahrungspunkt. Erfahrung im Flug lässt Ihre Schiffe schneller fliegen."), _("Tritium")))?></p>
	<p><?=l::h(_("Pro Tausend Punkte, das Sie im Kampf Ihren Gegner verlieren ließen, bekommen Sie einen Kampferfahrungspunkt. Mehr Kampferfahrung schafft Ihnen Vorteile im Kampf."))?></p>
</div>

<div class="faq" id="noobs">
	<h3><?=l::h(_("Gibt es einen Anfängerschutz?"))?></h3>
	<p><?=l::h(sprintf(_("Ja, den gesamten Spielverlauf durch gilt eine Angriffssperre auf Spieler, die weniger als %s %% des eigenen Gesamtpunktestandes besitzen. Außerdem ist es Ihnen nicht möglich, Spieler anzugreifen, die aufgrund von Einschränkungen im Spiel (zum Beispiel dem Anfängerschutz) keine Angriffe auf Sie selbst fliegen können."), 5))?></p>
</div>
...
<div class="faq" id="umode">
	<h3><?=l::h(_("Was bewirkt der Urlaubsmodus?"))?></h3>
	<p><?=l::h(_("Mithilfe des Urlaubsmodus kann man seinen Account „einfrieren“, um während einer längeren Abwesenheit zu vermeiden, dass man angegriffen wird, ohne etwas dagegen tun zu können."))?></p>
	<p><?=l::h(_("Im Urlaubsmodus werden keine Rohstoffe mehr produziert, außerdem können keine Flotten mehr verschickt werden und kein Bau in Auftrag gegeben werden."))?></p>
	<p><?=l::h(sprintf(_("Im Urlaubsmodus erscheint in der Karte hinter dem Spielernamen ein „ (%s)“, daran können andere Spieler erkennen, dass der Benutzer sich im Urlaubsmodus befindet. Flüge zu Planeten, deren Besitzer sich im Urlaubsmodus befinden, sind nicht möglich, Trümmerfelder unterliegen dieser Einschränkung nicht."), _("U[rlaubsmodus]")))?></p>
	<p><?=l::h(_("Der Urlaubsmodus wird manuell durch den Benutzer beendet."))?></p>
</div>
...
<div class="faq" id="research">
	<h3><?=l::h(_("Wo ist der Unterschied zwischen globaler und lokaler Forschung?"))?></h3>
	<p><?=l::h(_("Die globale Forschung vernetzt sämtliche Forschungslabore Ihres Imperiums miteinander, während die lokale Forschung nur in demjenigen Forschungslabor weiterentwickelt wird, in dem sie in Auftrag gegeben wurde. Beide Forschungsmethoden benötigen die gleiche Rohstoffmenge, bei beiden werden die Rohstoffe desjenigen Planeten benutzt, auf dem die Forschung in Auftrag gegeben wurde. Die globale Forschung ist schneller als die lokale, da bei ihr mehrere Forschungslabore zusammenarbeiten, dafür besitzt sie den Nachteil, dass während einer globalen Forschung eben alle Forschungslabore beschäftigt sind, während Sie mit lokaler Forschung auf mehreren Planeten gleichzeitig forschen können."))?></p>
	<p><?=l::h(_("Beachten Sie: Die Bauzeit der globalen Forschung ist nicht unabhängig davon, von welchem Planeten man aus sie ausbaut. Eine höhere Ausbaustufe des Planeten, auf dem man die Forschung in Auftrag gibt, verkürzt die Bauzeit mehr als Ausbaustufen von Forschungslaboren auf anderen Planeten."))?></p>
</div>

<div class="faq" id="robots">
	<h3><?=l::h(_("Wie funktionieren die Roboter?"))?></h3>
	<p><?=l::h(sprintf(_("Die Roboter helfen, Gebäudebauzeiten zu verkürzen und die Rohstoffproduktion zu erhöhen. Der Auswirkungsgrad der Roboter hängt von der aktuellen Stufe %s ab. Jede Stufe %1\$s erhöht dabei den Auswirkungsgrad %s um einen Viertelprozentpunkt."), _("[item_F2_gen_def]"), _("[item_R01_pl_gen_poss_2]")))?></p>
	<p><?=l::h(sprintf(_("Für die Minenroboter gilt folgende Formel bei der Berechnung der Produktion:")))?></p>
	<p><?=l::h(_("Produktion = Ausgangsproduktion × ( Roboterzahl ⁄ 250 ) × ( 1 + WURZEL( Ausbaustufe der Roboterbautechnik ) )"))?></p>
	<p><?=l::h(sprintf(_("Beachten Sie, dass nur begrenzt Platz für Roboter auf Ihrem Planeten zur Verfügung steht. Die Grenze liegt bei der Hälfte der ursprünglichen Felderzahl des Planeten (%s zeigt also keine Wirkung), für Minenroboter besteht eine zusätzliche Grenze bei der aktuellen Ausbaustufe der zugehörigen Mine (Ausnahme: %s, hier liegt die Grenze beim 2-Fachen der Ausbaustufe %s). Übersteigt die Roboterzahl die Grenze, zeigen überschüssige Roboter keinerlei Wirkung mehr."), _("[item_F9_nom]"), _("[item_R06_pl_nom]"), _("[item_B4_gen_def]")))?></p>
</div>

<div class="faq" id="fleet">
	<h3><?=l::h(_("Wieviele Flotten kann ich gleichzeitig verschicken?"))?></h3>
	<p><?=l::h(sprintf(_("Die Anzahl der gleichzeitig koordinierbaren Flotten berechnet sich aus der Entwicklungsstufe %s und der Anzahl der Werften in Ihrem Imperium. Potenzieren Sie einfach das Produkt der beiden Werte mit 0,7 und runden Sie das Ergebnis auf."), _("[item_F0_gen_def]")))?></p>
	<p><?=l::h(sprintf(_("Nocheinmal zum Mitschreiben: Anzahl gleichzeitig koordinierbarer Flotten = aufgerundet((%s*Werftenzahl)^0,7)."), _("[item_F0]")))?></p>
</div>

<div class="faq" id="alliance">
	<h3><?=l::h(_("Was bringt mir ein Bündnis?"))?></h3>
	<p><?=l::h(_("Wenn Sie sich mit einem Spieler verbünden, dient das nicht nur der Diplomatie, sondern hat auch praktische Auswirkungen im Spielverlauf."))?></p>
	<ul>
		<li><?=l::h(_("In der Karte werden verbündete Spieler farblich hervorgehoben, sodass Sie immer die Übersicht behalten."))?></li>
		<li><?=l::h(_("Sie können verbündete Spieler nicht angreifen."))?></li>
		<li><?=l::h(_("Wenn Sie Ihren Verbündeten ausspionieren, wird Ihre Spionage nicht abgewehrt und Sie sehen vollständige Informationen über den Planeten, unabhängig von Spionagetechnik und der Anzahl der Spionagesonden, die Sie geschickt haben."))?></li>
		<li><?=l::h(_("In der Spielerinformation sehen Sie die Koordinaten Ihrer Verbündeten und deren ausgegebene Rohstoffe."))?></li>
		<li><?=l::h(_("Bündnisrundschreiben machen es möglich, dass Sie all Ihren Verbündeten gleichzeitig eine Nachricht zukommen lassen."))?></li>
	</ul>
</div>

<div class="faq" id="resources">
	<h3><?=l::h(_("Die Rohstoffanzeige passt nicht in mein Browserfenster und Querscrollen ist nicht möglich."))?></h3>
	<p><?=l::h(_("Dies ist eine kleine Einschränkung der derzeitigen Formatierungsmöglichkeiten, die einem Webdesigner zur Verfügung stehen. Ein Querscrollen ist nur in der „non-fixed ress“-Variante der Skins verfügbar, wählen Sie in den Einstellungen einfach diese aus."))?></p>
</div>
...
<div class="faq" id="universe">
	<h3><?=l::h(_("Wie viele Universen gibt es?"))?></h3>
	<p><?=l::h(_("Derzeit gibt es nur ein Universum, und das wird sich auch so schnell nicht ändern. Das Universum enthält aber mehrere Galaxien, die Anzahl letzterer wird je nach Anzahl besiedelter Planeten ständig erweitert."))?></p>
</div>
...
<div class="faq" id="expand">
	...
	<ul>
		...
		<li><?=l::h(_("Sie wollen global forschen, aber es können nicht alle Forschungslabore benutzt werden, da sich ein Forschungslabor im Ausbau befindet oder irgendwo geforscht wird."))?></li>
		<li><?=l::h(_("Es wird bereits gebaut/geforscht. Vermutlich haben Sie dies übersehen und müssen scrollen, um den entsprechenden Ausbau zu erreichen."))?></li>
	</ul>
</div>
